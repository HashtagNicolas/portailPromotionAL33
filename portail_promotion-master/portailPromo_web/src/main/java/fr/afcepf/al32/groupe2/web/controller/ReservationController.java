...
public class ReservationController {
	...
	@PostMapping("byCommercant/{idCommercant}")
	public List<Reservation> getBookList(@PathVariable Long idCommercant) {
		
		return serviceReservation.findAllByShopKeeper((Shopkeeper) authenticationService.findOneById(idCommercant));
	}
